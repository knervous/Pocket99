...
{
    public partial class HealthManaBar : UserControl
    {
        static Canvas _background;
        static Border _healthBackground;
        static Border _healthBar;
        static Border _healthTicks;
        static Border _manaBackground;
        static Border _manaBar;
        static Border _manaTicks;
        static TextBlock _firstName;
        static TextBlock _lastName;

        public HealthManaBar()
        {
        ...
        private void OnInitialized(object sender, EventArgs e)
        {
            ...
            _manaBackground = (Border)FindName("ManaBackground");
            _manaBar = (Border)FindName("ManaBar");
            _manaTicks = (Border)FindName("ManaTicks");
            _firstName = (TextBlock)FindName("FirstName");
            _lastName = (TextBlock)FindName("LastName");

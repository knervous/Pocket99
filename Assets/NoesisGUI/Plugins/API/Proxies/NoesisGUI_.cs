...
public class NoesisGUI_ {
  ...
  public static Nullable<bool> Unbox_NullableBool(IntPtr val) {
  ...
  public static IntPtr Box_NullableBool(Nullable<bool> val) {
  ...
  public static Nullable<short> Unbox_NullableInt16(IntPtr val) {
  ...
  public static IntPtr Box_NullableInt16(Nullable<short> val) {
  ...
  public static Nullable<ushort> Unbox_NullableUInt16(IntPtr val) {
  ...
  public static IntPtr Box_NullableUInt16(Nullable<ushort> val) {
  ...
  public static Nullable<int> Unbox_NullableInt32(IntPtr val) {
  ...
  public static IntPtr Box_NullableInt32(Nullable<int> val) {
  ...
  public static Nullable<uint> Unbox_NullableUInt32(IntPtr val) {
  ...
  public static IntPtr Box_NullableUInt32(Nullable<uint> val) {
  ...
  public static Nullable<float> Unbox_NullableFloat(IntPtr val) {
  ...
  public static IntPtr Box_NullableFloat(Nullable<float> val) {
  ...
  public static Nullable<double> Unbox_NullableDouble(IntPtr val) {
  ...
  public static IntPtr Box_NullableDouble(Nullable<double> val) {
  ...
  public static Nullable<Color> Unbox_NullableColor(IntPtr val) {
  ...
  public static IntPtr Box_NullableColor(Nullable<Color> val) {
  ...
  public static Nullable<Point> Unbox_NullablePoint(IntPtr val) {
  ...
  public static IntPtr Box_NullablePoint(Nullable<Point> val) {
  ...
  public static Nullable<Rect> Unbox_NullableRect(IntPtr val) {
  ...
  public static IntPtr Box_NullableRect(Nullable<Rect> val) {
  ...
  public static Nullable<Size> Unbox_NullableSize(IntPtr val) {
  ...
  public static IntPtr Box_NullableSize(Nullable<Size> val) {
  ...
  public static Nullable<Thickness> Unbox_NullableThickness(IntPtr val) {
  ...
  public static IntPtr Box_NullableThickness(Nullable<Thickness> val) {
  ...
  public static Nullable<CornerRadius> Unbox_NullableCornerRadius(IntPtr val) {
    ...
    if (ret != IntPtr.Zero) {
      ...
      return new Nullable<CornerRadius>();
    }
  }

  public static IntPtr Box_NullableCornerRadius(Nullable<CornerRadius> val) {
  ...
  public static Nullable<TimeSpan> Unbox_NullableTimeSpan(IntPtr val) {
  ...
  public static IntPtr Box_NullableTimeSpan(Nullable<TimeSpan> val) {
  ...
  public static Nullable<Duration> Unbox_NullableDuration(IntPtr val) {
    ...
    if (ret != IntPtr.Zero) {
      ...
      return new Nullable<Duration>();
    }
  }

  public static IntPtr Box_NullableDuration(Nullable<Duration> val) {
  ...
  public static Nullable<KeyTime> Unbox_NullableKeyTime(IntPtr val) {
    ...
    if (ret != IntPtr.Zero) {
      ...
      return new Nullable<KeyTime>();
    }
  }

  public static IntPtr Box_NullableKeyTime(Nullable<KeyTime> val) {

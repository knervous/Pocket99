...
namespace UserInterface
{
    public partial class Chat : UserControl
    {
        ...
        private void OnInitialized(object sender, EventArgs e)
        {
            ...
            _ChatHeaderText.Width = Constants.WinWidth * .85f;
            _ChatHeaderText.Height = Constants.WinHeight * .066f;
            _ChatHeaderText.FontSize = Constants.WinHyp * .015f;
            Canvas.SetLeft(_ChatHeaderText, Constants.WinWidth * .075f);
            Canvas.SetTop(_ChatHeaderText, Constants.WinHeight * .08f);

            _ChatDrag.Width = Constants.WinHyp * .075f;
            _ChatDrag.Height = Constants.WinHyp * .04f;
            Canvas.SetTop(_ChatDrag, 0);
            Canvas.SetLeft(_ChatDrag, Constants.WinWidth * .45f);

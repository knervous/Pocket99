    ...
    public partial class Chat : UserControl
    {
        ...
        private void OnInitialized(object sender, EventArgs e)
        {
            ...
            foreach (var c in _MessageType.Items)
            {
                ...
                f.Height = Constants.WinHeight * .05f;
        ...
        private void SendMessage(object sender, RoutedEventArgs e)
        {
            ...
            LocalChatInsert(sel.Content.ToString(), _ChatEntry.Text);
            _ChatEntry.Text = string.Empty;
        ...
        public static void LocalChatInsert(string type, string content)
        {
            switch (type)
            {
                case "Find":
                    InsertChatMessage("Searching...");
                    break;
                case "OOC":
                    InsertChatMessage("You say out of character, '" + content + "'");
                    break;
            }
        }
